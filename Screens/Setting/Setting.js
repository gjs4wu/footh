	...
	render() {
		...
		return <View
				...
				<View
					...
					<Text
						style={styles.useridText}>Hello User</Text>
				</View>
				<View
					pointerEvents="box-none"
					style={{
				...
				<View
					...
					<View
						...
						<View
							...
							<Text
								style={styles.ratesText}>24ratings</Text>
						</View>
						<View
							style={{
								flex: 1,
					...
					<View
						...
						<View
							...
							<Text
								style={styles.tacobellThreeText}>Kompot</Text>
							<Text
								style={styles.ratesThreeText}>99ratings</Text>
						</View>
						<View
							style={{
								flex: 1,
