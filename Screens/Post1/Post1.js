		...
		return <View
				...
				<View
					...
					<View
						...
						<Image
							source={require("./../../assets/images/mexicanfood.png")}
							style={styles.group39Image}/>
						<Text
							style={styles.foodText}>Mexican</Text>
					</View>
					<View
						style={{
							flex: 1,
					...
					<View
						...
						<Image
							source={require("./../../assets/images/russianfood.png")}
							style={styles.group2Image}/>
						<Text
							style={styles.sportText}>Russian</Text>
					</View>
				</View>
				<View
					pointerEvents="box-none"
					...
					<View
						...
						<Image
							source={require("./../../assets/images/germanfood.jpg")}
							style={styles.iconFourImage}/>
						<Text
							style={styles.rentText}>German</Text>
					</View>
					<View
						style={{
							flex: 1,
					...
					<View
						style={styles.rentView}>
						<Image
							source={require("./../../assets/images/frenchfood.png")}
							style={styles.iconFourImage}/>
						<Text
							style={styles.rentText}>French</Text>
					</View>
				</View>
				<View
					style={{
				...
				<View
					...
					<View
						style={styles.rentView}>
						<Image
							source={require("./../../assets/images/chinesefood.png")}
							style={styles.iconFourImage}/>
						<Text
							style={styles.rentText}>Chinese</Text>
					</View>
					<View
						style={{
							flex: 1,
					...
					<View
						style={styles.rentView}>
						<Image
							source={require("./../../assets/images/koreanfood.png")}
							style={styles.iconFourImage}/>
						<Text
							style={styles.rentText}>Korean</Text>
					</View>
				</View>
				</ScrollView>
			</View>
